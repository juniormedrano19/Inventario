...
$instaladoOffice=""
 ...
 $instaladoOffice = $office.DisplayName;
	...
	if($antivirus){
		...
		$instaladoForti= "No tiene office"
	}
    ...
    $serie= Get-WmiObject win32_bios;
     ...
     $texto="" +$localIpAddress+","+$Pc.model+","+$Pc.Manufacturer+","+$serie.SerialNumber+","+$Processor.Name+","+$Cores+","+$discoSize+","+$Class.Caption+","+$env:computerName.ToUpper()+","+$Class.OSArchitecture+","+$Class.ServicePackMajorVersion+","+$Memory.'Installed Memory (RAM)'+","+$sipVersion+","+$jabra+","+$extension+","+$usuario+","+$fullname+","+$instaladoOffice+","+$instaladoForti
...
$dataGridView.Rows.Add($row1[0],$row1[1],$row1[2],$row1[3],$row1[4],$row1[5],$row1[6],$row1[7],$row1[8],$row1[9],$row1[10],$row1[11],$row1[12],$row1[13],$row1[14],$row1[15],$row1[16],$row1[17],$row1[18])}
